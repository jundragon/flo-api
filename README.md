...
- 샘플 데이터(`albums.json`)는 Spring bean 이 모두 생성된 후 초기화 하는 부분에서 DB 에 추가할 수 있음 (InitDB)
...
- flyway migrate : `src/main/resources/db/migration`

  - `V1_schema.sql ` : schema
  - `V2_data.sql` : data insert
